...
export function getFile(filePath: string, wfs: Directory, currentPath: string = '~'): ?File {
...
export function getDirectory(filePath: string, wfs: Directory, currentPath: string = '~'): ?Directory {
    const top = getStack(currentPath + '/' + filePath, wfs).pop();
    if (top && top.type === 'dir') {
...
export function getPath(path: string, wfs: Directory, currentPath: string = '~'): string {
...
export function getCurrentWindow(state: StoreState) {
    return state.workspaces[state.selectedWorkspace].windows.find(w => w.id === state.selectedWindow);
}
...
export function getBorderingLeft(index: number, windows: Array<Window>, isStrict: boolean = true) {
...
export function getBorderingRight(index: number, windows: Array<Window>, isStrict: boolean = true) {
    return borderingComp(
        index,
        windows,
        (a, b) => b.x === a.x + a.width,
...
export function getBorderingTop(index: number, windows: Array<Window>, isStrict: boolean = true) {
    return borderingComp(
        index,
        windows,
...
export function getBorderingBottom(index: number, windows: Array<Window>, isStrict: boolean = true) {
    return borderingComp(
        index,
        windows,
